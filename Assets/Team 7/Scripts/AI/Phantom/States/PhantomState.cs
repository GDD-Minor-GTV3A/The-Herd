namespace Team_7.Scripts.AI.Phantom.States
{
    public class PhantomState : GenericEnemyState
    {
        ...
        protected PhantomState(PhantomStateManager manager, EnemyMovementController movement, PhantomStats stats, PhantomAnimatorController animator, AudioController audio) : base(movement, audio)
        {
            _animator = animator;
            _manager = manager;
            _stats = stats;
